...
@foreach($specificKonkurrence as $item)

    <div class='container-fluid article' style='
            background-image: url(/img/{{ $item->coverImage }});
    ...
    <div class='container-fluid'>
        <div class='articleContent' style='border-top: 3px solid #BD74E8'>
            <div class="row">
                <div class='col-sm-2'>
                ...
                <div class='col-sm-7'>
                    <img style="width: 100%; margin-bottom: 50px;" src="/img/{{ $item->coverImage }}">
                    {!! $item->description !!}
                </div>
